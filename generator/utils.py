...
####
def add_app_to_installed_apps(base_path, app_name):
    project_settings_path = os.path.join(base_path, "settings.py")
...
def generate_app_files(app_path,app_name, models_spec, endpoints_spec,base_path,project_name):
    ...
    add_app_to_installed_apps(base_path, app_name)
    ...
    os.makedirs(os.path.dirname(project_urls_path), exist_ok=True)
